...
$(function(){		
	...
	jQuery('.header-fixed').on('click',function() { 
		...
		jQuery("body").removeClass('car-details-no');
	});
	
	jQuery('.header-static').on('click',function() { 
		jQuery(".main-bar-wraper").addClass('sticky-no');
		jQuery(".main-bar-wraper").removeClass('sticky-header');
		jQuery("body").addClass('car-details-no');
	});
	/* Header View END */
...
/* Theme Panel Save */
	...
	var themeOption = ['themeStandardColor','themeFullColor','layout','mode','header','menubar','bgColor','bgImage','bgPatten','logo'];
