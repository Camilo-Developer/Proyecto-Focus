                        ...
                        <form action="{{route('admin.agglomerations.update',$agglomeration)}}" method="post" enctype="multipart/form-data">
                            ...
                            @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{strtoupper($agglomeration->name)}}" required class="form-control form-control-border" id="name" placeholder="NOMBRE">
                                    </div>
                                    @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="type_agglomeration" value="{{strtoupper($agglomeration->type_agglomeration)}}" required class="form-control form-control-border" id="type_agglomeration" placeholder="TIPO">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="setresidencial_id" id="setresidencial_id">
                                            ...
                                            @foreach($setresidencials as $setresidencial)
                                                <option value="{{ $setresidencial->id }}" {{ $setresidencial->id == $agglomeration->setresidencial_id ? 'selected' : '' }} {{ old('setresidencial_id') == $setresidencial->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select form-control-border" name="state_id" id="state_id">
                                            ...
                                            @foreach($states as $state)
                                                <option value="{{$state->id}}" {{ $state->id == $agglomeration->state_id ? 'selected' : '' }} {{ old('state_id') == $state->id ? 'selected' : '' }}>{{strtoupper($state->name)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('state_id')
