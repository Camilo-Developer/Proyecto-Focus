                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <input size="20"  type="file" name="imagen_file" class="form-control form-control-border mt-2 w-50" accept="image/*">
                                                    </div>
...
@enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{mb_strtoupper($visitor->phone)}}" name="phone"  class="form-control form-control-border" id="phone" placeholder="TELÉFONO">
                                        </div>
                                        @error('phone')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
